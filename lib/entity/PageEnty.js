...
var  PageEnty = (function() {
    var  PageEnty = function(repo, name, data) {
        ...
        this.getFields = function()  {
            return  ['title', 'summary', 'body', 'isPublic', '_loc'];
        };
        ...
        this.detach = function(cnID, callback)  {
            var  master = this.getMaster(),
                 rsName,
                 id;
        ...
        this.listAux = function(nType, callback)  {
            if (typeof nType !== 'number')
                ...
                if (master)
                    apiPath = master.name + '.page/listAux/' + master.id + '.' + this.getId();
                else  {
                    var  nid = this.nameId();
        ...
        this.tag = function(twords, callback)  {
            ...
            if (master)
                apiPath = master.name + '.page/tag/' + master.id + '.' + this.getId();
            else  {
                var  nid = this.nameId();
        ...
        /* list geo-locations of a page */
        this.listGeo = function(params, callback)  {
            var  master = this.getMaster();
            ...
            if (master)
                ...
                var  apiPath = this.__name + '.geoLoc/list/' + this.getId();
